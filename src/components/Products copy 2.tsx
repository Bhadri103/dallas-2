...
const ProductsPage = () => {
  ...
  const [activeTechData, setActiveTechData] = useState(null);
  ...
  const testimonials = [
    {
      ...
      rating: 5,
      comment: "Dallas waterproof plaster has been amazing. No dampness issues for 3 years now. The lifetime guarantee gives great peace of mind.",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Used Dallas products for our office building. The application was easy and the finish quality is excellent. Highly recommended!",
    ...
    },
    {
      ...
      rating: 5,
      comment: "Factory direct pricing saved us significant costs. The technical support team was very helpful throughout the project.",
  ...
  const wallPlasterTechData = [
    { property: "Product Name", value: "Dallas Ready Plast (Waterproof Wall Plaster)", isCode: "" },
  ...
  const wallPuttyTechData = [
    { property: "Product Name", value: "Dallas Supreme White Wallputty", isCode: "" },
  ...
  const certifications = [
    { name: "BIS Certification", code: "IS 269", icon: <BadgeCheck className="w-6 h-6" /> },
    { name: "ISO 9001:2015", code: "Quality Management", icon: <Award className="w-6 h-6" /> },
    { name: "CE Marking", code: "European Conformity", icon: <CheckCircle className="w-6 h-6" /> },
    { name: "Green Building", code: "IGBC Approved", icon: <Leaf className="w-6 h-6" /> },
  ];
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <section className="py-12 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          {/* Certifications */}
          <div className="mt-12">
            <h3 className="text-xl font-bold text-center mb-6">Certifications & Standards</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {certifications.map((cert, idx) => (
                <div key={idx} className="bg-gray-50 p-4 rounded-lg text-center">
                  <div className="text-blue-600 mb-2 flex justify-center">{cert.icon}</div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4">
                    ...
                    <div className="bg-green-50 p-2 rounded text-center">
                      ...
                      <div className="text-xs font-semibold">{product.deliveryTime}</div>
                    </div>
                  </div>
                  ...
                  {product.mainProducts && (
                    <div className="space-y-2 mb-4">
                      ...
                      {product.mainProducts.slice(0, 2).map((item, idx) => (
                        <div
                          key={idx}
                  ...
                  {/* Regular Features for other products */}
                  {product.features && !product.mainProducts && (
                    <div className="space-y-2 mb-4">
                      <h4 className="font-semibold text-sm text-gray-800">
                        Key Features:
                      </h4>
