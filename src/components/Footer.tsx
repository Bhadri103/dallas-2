          ...
          <div>
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-bold">
                <span className="text-red">DALLAS</span>
                <span className="text-yellow">WALLCARE</span>
              </span>
            </div>
            <p className="text-gray-400 mb-6">
              Leading manufacturer of high-quality plastic products serving
              diverse industries with innovative solutions since 2005.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"
                className="bg-gray-800 p-2 rounded-full hover:bg-red transition-colors duration-300"
              >
                <Facebook size={20} />
              </a>
              <a
