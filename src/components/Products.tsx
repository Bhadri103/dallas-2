    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to Build with Dallas?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Contact us today for product inquiries, technical support, or to
            place an order.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <a
              href="tel:+919342216880"
              className="inline-flex items-center bg-white text-red-600 px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition-colors shadow-lg"
            >
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Dallas WellCare Pvt Ltd.</h3>
            <p className="text-gray-400 text-sm mb-2">
              Innovating construction with superior quality and lasting
              protection.
            </p>
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Dallas WellCare. All rights
              reserved.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm flex items-center mb-2">
              ...
              123 Main Road, Chennai, Tamil Nadu, India
            </p>
            <p className="text-gray-400 text-sm flex items-center mb-2">
