...
import { ChevronDown, ChevronUp, Shield, Award, Droplets, Zap, Leaf, Settings, CheckCircle, Star } from 'lucide-react';

const productSlides = [
  {
    image: "https://images.pexels.com/photos/3862130/pexels-photo-3862130.jpeg",
    title: "Premium Dampproof Solutions",
    description: "India's 1st scientifically engineered waterproof construction materials"
  },
  {
...
const Products = () => {
  ...
  const productCategories = [
    {
      ...
      icon: '🏗️',
      products: ['Ready Plast', 'Ready Plaster (Non-Trade)', '0 Cure Plaster', 'Dallas Grout', 'Dallas Gypsum Plast']
    },
    {
      id: 'wall-putty',
  ...
  const technicalData = [
    { property: 'Product Name', value: 'Dallas Ready Plast (Waterproof Wall Plaster)', reference: '' },
    { property: 'Manufacturer', value: 'Dallas WellCare Pvt Ltd.', reference: '' },
    ...
    { property: 'Compressive Strength', value: '> 9.5 MPa (after 28 days)', reference: 'IS 4031:1988' },
    { property: 'Thermal Conductivity', value: '0.1 - 0.2 W/m·K', reference: 'IS 3362:1985' },
    { property: 'pH Level', value: '7 - 9', reference: '' },
    { property: 'Shelf Life', value: '12 months', reference: '' },
    { property: 'Fire Resistance', value: 'Non-combustible (Class A)', reference: 'IS 3808:2009' },
    { property: 'Coverage', value: '1.5 - 2.0 m² per kg (at 12 mm thickness)', reference: '' }
  ];
  ...
  return (
    <div className="bg-gray-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our focus is on quality over quantity, offering high-performance materials such as waterproofing plasters, 
              wall putty, gypsum plaster, waterproof polymers and protective coatings—each tailored to meet the diverse 
              construction needs of the region.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-600 to-yellow-500 rounded-2xl p-8 mb-16 text-white text-center">
            ...
            <p className="text-lg md:text-xl opacity-90 max-w-3xl mx-auto">
              Dallas Wallcare specializes in next-generation dampproof solutions that revolutionize construction 
              standards across India. Our scientifically engineered products provide lifetime protection against 
              water damage, mold, and environmental stress.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">Main Product Categories</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="animate-on-scroll">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <Shield className="w-5 h-5 text-red-600 mr-3" />
                    Waterproof 2X Plaster Bag (50 KG) for bathroom & highly damp areas
                  </li>
                  <li className="flex items-center">
              ...
              <div className="bg-yellow-50 p-6 rounded-lg">
                <h3 className="text-xl font-bold mb-4 text-yellow-800">Special Features:</h3>
          ...
          <div className="animate-on-scroll bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 mb-12">
            <h3 className="text-2xl font-bold mb-6 text-center">Application Procedure</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">1</div>
                <p className="text-sm">Fill a 200-litre drum with clean water</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">2</div>
                <p className="text-sm">Add 2 litres of Dallas Watertreater to the water and mix gently</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">3</div>
                <p className="text-sm">Add Dallas Ready Plaster with 16–20% of prepared water mixture</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md text-center">
                ...
                <p className="text-sm">Mix thoroughly and apply using standard plastering techniques</p>
              </div>
            </div>
          </div>
          ...
          <div className="animate-on-scroll">
            ...
            >
              <div className="flex items-center justify-between">
                <h3 className="text-2xl font-bold">Technical Data Sheet (TDS)</h3>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="border border-gray-300 px-4 py-3 text-left font-bold">Property</th>
                        <th className="border border-gray-300 px-4 py-3 text-left font-bold">Value</th>
                        <th className="border border-gray-300 px-4 py-3 text-left font-bold">IS Code / Reference</th>
                      </tr>
                    </thead>
                    <tbody>
                      {technicalData.map((row, index) => (
                        <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                          <td className="border border-gray-300 px-4 py-3 font-medium">{row.property}</td>
                          <td className="border border-gray-300 px-4 py-3">{row.value}</td>
                          <td className="border border-gray-300 px-4 py-3 text-blue-600">{row.reference}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll order-2 lg:order-1">
              ...
              <div className="bg-red-600 text-white p-6 rounded-lg">
                ...
                <p className="text-lg">
                  Dallas offers its waterproof wall putty at a <strong>50% discount</strong> off the Maximum Retail Price (MRP), 
                  allowing customers to purchase high-quality waterproof wall putty at half the regular price.
                </p>
              </div>
            </div>
          ...
          {/* Wall Putty Application Steps */}
          <div className="animate-on-scroll mt-16">
            <h3 className="text-2xl font-bold text-center mb-8">Application Procedure</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-sm text-gray-600">Fill 200-liter drum with clean water. Add 2 liters Dallas Watertreater and mix gently.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="font-bold text-lg mb-3 text-red-600">Step 2</h4>
                <h5 className="font-semibold mb-2">Prepare Special Grout</h5>
                <p className="text-sm text-gray-600">Use W-Treated Water to mix with Dallas grout. Ensure thorough mixing for consistency.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="font-bold text-lg mb-3 text-red-600">Step 3</h4>
                <h5 className="font-semibold mb-2">Mix Dallas Wall Putty</h5>
                <p className="text-sm text-gray-600">Add 28–30% W-Treated Water to putty. Mix until uniform, lump-free consistency.</p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h4 className="font-bold text-lg mb-3 text-red-600">Step 4</h4>
                <h5 className="font-semibold mb-2">Application Process</h5>
                <p className="text-sm text-gray-600">Paint wall with grout, let set, then apply Dallas Wall Putty (2-3 coats).</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Professional-grade gypsum plaster solutions designed for superior finish and durability</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="animate-on-scroll bg-white p-6 rounded-xl shadow-lg text-center">
              <Award className="w-12 h-12 text-yellow-500 mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">High-Quality Formulation</h3>
              <p className="text-gray-600">Premium gypsum blend for optimal performance</p>
            </div>
            <div className="animate-on-scroll bg-white p-6 rounded-xl shadow-lg text-center">
              <Settings className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">Superior Adhesion</h3>
              <p className="text-gray-600">Excellent workability and surface bonding</p>
            </div>
            <div className="animate-on-scroll bg-white p-6 rounded-xl shadow-lg text-center">
              <Star className="w-12 h-12 text-green-500 mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">Smooth Finish</h3>
              <p className="text-gray-600">Professional-grade surface finish capability</p>
            </div>
            <div className="animate-on-scroll bg-white p-6 rounded-xl shadow-lg text-center">
              <Shield className="w-12 h-12 text-red-500 mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2">System Compatible</h3>
              <p className="text-gray-600">Works seamlessly with Dallas waterproofing systems</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-br from-red-50 to-yellow-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Why Choose Dallas Products?</h2>
            <p className="text-xl text-gray-600">Eight compelling reasons to choose Dallas for your construction needs</p>
          </div>
